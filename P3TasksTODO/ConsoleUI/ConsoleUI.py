...
def main():
    ...
    container1 = add_item(1,container1)#Add list
    container2 = add_item((2,'e'),container2)#Add to dictionary
    container2 = add_item((3,'e'),container2)#Add to dictionary
    container2 = add_item((4,'e'),container2)#Add to dictionary
    ...
    #print(container1)
    #container2 = update_item(1,9,container2)
    #container3 = update_item(1,9,container3)
    #container4 = update_item(1,9,container4)
    #---------------------------------------------------
    #Convert Container
